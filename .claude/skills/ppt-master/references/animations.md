...
python3 .claude/skills/ppt-master/scripts/animation_config.py scaffold <project>

# Validate references before export
python3 .claude/skills/ppt-master/scripts/animation_config.py validate <project>

# Export reads <project>/animations.json automatically when present
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project>
```
...
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -t push --transition-duration 0.6

# Remove the visual transition
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -t none

# Auto-advance every 5 seconds (kiosk-style playback)
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> --auto-advance 5

# Auto-advance with no visual transition
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -t none --auto-advance 5
```
...
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -a auto

# Enable with a single effect (cascades via the after-previous trigger)
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> --animation fade

# Enable and switch to on-click for live presentations (presenter controls pacing)
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -a auto --animation-trigger on-click

# Custom pacing
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> --animation mixed \
        --animation-stagger 0.7 --animation-duration 0.5

# All groups animate in unison on slide entry
python3 .claude/skills/ppt-master/scripts/svg_to_pptx.py <project> -a auto --animation-trigger with-previous
```
...
Executors should wrap logical sections in `<g id>` regardless of whether you plan to animate. The Executor reference (`.claude/skills/ppt-master/references/shared-standards.md`) requires it.
