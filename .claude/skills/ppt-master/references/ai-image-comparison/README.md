...
python3 .claude/skills/ppt-master/scripts/image_gen.py \
    --manifest .claude/skills/ppt-master/references/ai-image-comparison/rendering/_manifest.json \
    -o .claude/skills/ppt-master/references/ai-image-comparison/rendering/ \
    --backend openai

python3 .claude/skills/ppt-master/scripts/image_gen.py \
    --manifest .claude/skills/ppt-master/references/ai-image-comparison/palette/_manifest.json \
    -o .claude/skills/ppt-master/references/ai-image-comparison/palette/ \
    --backend openai

python3 .claude/skills/ppt-master/scripts/image_gen.py \
    --manifest .claude/skills/ppt-master/references/ai-image-comparison/type/_manifest.json \
    -o .claude/skills/ppt-master/references/ai-image-comparison/type/ \
    --backend openai
```
