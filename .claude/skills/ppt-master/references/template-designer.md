...
- **Workspace root**: `library` (default) → `.claude/skills/ppt-master/templates/<kind_dir>/<template_name>/`; `project` → the confirmed `<target_project>/`
...
|---|---|
| `library` | `.claude/skills/ppt-master/templates/<kind_dir>/<template_name>/` |
