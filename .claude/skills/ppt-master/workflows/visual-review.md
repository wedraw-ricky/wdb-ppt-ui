...
python3 .claude/skills/ppt-master/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 .claude/skills/ppt-master/scripts/visual_review.py <project_path>
```
