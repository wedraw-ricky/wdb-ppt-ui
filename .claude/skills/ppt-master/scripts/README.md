...
python3 scripts/verify_deck.py <project_path>  # final verification gate + one contact-sheet render
python3 scripts/verify_deck.py <project_path> --no-render  # same checks, render skipped while iterating
```
