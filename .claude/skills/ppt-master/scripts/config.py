...
# Repository root directory (skill may live under <root>/skills or <root>/.claude/skills)
...
SVG_CONSTRAINTS = {
    'authority': '.claude/skills/ppt-master/references/shared-standards.md',
    'validator': '.claude/skills/ppt-master/scripts/svg_quality_checker.py',
}
