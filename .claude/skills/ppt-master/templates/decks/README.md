...
|---|---|---|
| Library | `.claude/skills/ppt-master/templates/decks/<deck_id>/` | Register in `decks_index.json` |
...
- [`docs/templates-architecture.md`](../../../../../docs/templates-architecture.md) — three-class data model + fusion rules
