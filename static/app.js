...
(function () {
    ...
    var MESSAGES = {
        ...
        ko: {
            page_title: "PPT 만들기 — 디자인 정하기",
            topbar_hint: "고르고 나서 아래 버튼만 누르면 됩니다. 창이 닫히면 채팅으로 돌아오세요.",
            stage_anchors: "1단계 · 무엇을, 누구에게",
            stage_design: "2단계 · 어떤 모습으로",
            stage_images: "3단계 · 이미지와 마무리",
            loading: "불러오는 중…",
            load_error: "추천안을 불러오지 못했습니다. 채팅으로 돌아가 다시 시도해 주세요.",
            btn_confirm: "이대로 만들기",
            btn_next: "다음 →",
            deriving: "고르신 내용에 맞춰 다음 단계를 준비하는 중…",
            connection_lost: "연결이 끊겨 다시 붙는 중입니다. 계속 안 되면 채팅으로 돌아가 진행하세요.",
            already_confirmed: "이미 한 번 확정했습니다. 다시 누르면 앞의 선택을 덮어씁니다.",
            confirmed_title: "✓ 다 정했습니다",
            confirmed_hint: "선택이 저장됐습니다. 이 창을 닫고 채팅으로 돌아가세요.",
            lang_toggle_title: "언어 전환",
            sec_canvas: "어떤 크기로 만들까요?",
            sec_pages: "몇 장으로 만들까요?",
            sec_audience: "누가 보나요?",
            sec_style: "어떻게 설명하고, 어떤 느낌으로?",
            sec_template: "이미 있는 디자인을 쓸까요?",
            template_locked_note: "이미 정해진 템플릿입니다 — 여기서는 바꿀 수 없습니다",
            sec_color: "색을 골라주세요",
            sec_icons: "아이콘은 어떤 느낌으로?",
            sec_type: "글꼴과 글씨 크기",
            sec_images: "이미지는 어떻게 할까요?",
            sec_mode: "한 번에 끝낼까요, 나눠서 할까요?",
            sec_refine: "만들기 전에 계획서를 먼저 볼까요?",
            sub_mode: "설명 방식",
            sub_visual: "화면 분위기",
            sub_template_adherence: "템플릿을 얼마나 지킬까요?",
            sub_divergence: "원본을 얼마나 그대로 따를까요?",
            placeholder_divergence: "자유롭게 적어주세요 — 예: \"문서 내용 그대로 가주세요\" / \"내용은 유지하되 순서와 표현은 자유롭게\". 비워 두면 알아서 균형을 잡습니다.",
            custom: "직접 입력",
            custom_placeholder: "직접 입력…",
            recommended: "추천",
            placeholder_audience: "예: 임원 보고용 / 신입사원 교육용 / 투자자 대상",
            placeholder_pages: "예: 12-15",
            hex_override: "색을 직접 지정하기:",
            formula_policy: "수식이 들어가나요?",
            image_ai_path: "이미지를 어디서 만들까요?",
            image_strategy: "이미지 분위기",
            image_strategy_empty: "아직 제안된 이미지 분위기가 없습니다.",
            image_strategy_rendering: "그림체",
            image_strategy_palette: "색 쓰는 방식",
            image_strategy_visual: "생김새",
            image_strategy_color: "색",
            image_strategy_mood: "느낌",
            image_strategy_manual: "직접 정하기",
            image_strategy_manual_desc: "그림체와 색 쓰는 방식을 직접 고르거나, 원하는 바를 글로 적을 수 있습니다.",
            image_strategy_custom_prompt: "원하는 이미지 설명",
            image_strategy_custom_placeholder: "무엇을 그릴지, 어떤 구도로, 어떤 느낌으로. 피하고 싶은 것도 적어주세요.",
            image_strategy_reference_hint: "예시 이미지는 그림체와 색 쓰는 방식만 보여줍니다. 실제 색은 위에서 고른 색을 따릅니다.",
            image_strategy_color_follow: "위에서 고른 색을 그대로 씁니다. 여기서는 색을 어떻게 배분할지만 정합니다.",
            image_strategy_no_reference: "직접 정하기에는 예시 이미지가 없습니다.",
            image_usage_notes: "이미지에 대해 더 하실 말씀",
            image_usage_notes_placeholder: "예: 실제 사진 위주로, 만화풍 일러스트는 빼주세요. 제품 사진은 준 파일 그대로 써주세요.",
            image_usage_required: "이미지를 어떻게 할지 하나 이상 골라주세요.",
            image_usage_none_exclusive: "\"이미지 없이\"는 다른 항목과 같이 고를 수 없습니다.",
            font_heading: "제목",
            font_body: "본문",
            font_body_size: "본문 글씨 크기",
            font_body_size_hint: "나머지 글씨 크기는 모두 이 값을 기준으로 정해집니다.",
            body_size_unit_relation: "화면 px ↔ 파워포인트 pt: 1px = 0.75pt",
            body_size_pt_hint: "파워포인트에서 약 {pt}pt로 보입니다",
            role_size_pt_hint: "약 {pt} pt",
            body_size_hint_canvas: "이 크기에는 약 {lo}–{hi}px를 권합니다.",
            body_size_hint_purpose: "이 용도의 권장값은 {def}px입니다.",
            body_size_hint_oor: "(지금 값이 보통 범위를 벗어났습니다 — 한 번 확인해 보세요.)",
            delivery_purpose: "어디서 보는 자료인가요?",
            delivery_purpose_hint: "가까이서 읽으면 글씨가 작아도 되고, 빔프로젝터로 띄우면 커야 합니다.",
            size_override: "글씨 크기 개별 조정:",
            size_override_hint: "본문 크기를 바꾸면 나머지도 비례해서 같이 움직입니다.",
            size_role_title: "제목",
            size_role_subtitle: "부제목",
            size_role_annotation: "작은 설명",
            custom_typography: "글꼴 직접 정하기",
            custom_typography_placeholder: "예: 제목은 Paperlogy 굵게, 본문은 Pretendard 보통",
            custom_color: "색 직접 정하기",
            custom_color_placeholder: "말로 적어도 되고 HEX를 붙여넣어도 됩니다. 예: 짙은 남색 위주에 주황색 강조, 배경은 흰색",
            role_background: "배경",
            ...
            sample_body_latin: "Key message summary",
            style_preview_label: "전체 인상 미리보기 (색 + 글꼴 + 아이콘)",
            style_preview_body: "· 분위기만 확인하는 용도이며 실제 슬라이드 배치는 아닙니다",
            no_icons: "아이콘 안 씀",
            preview_big_title: "큰 제목",
            preview_section_title: "섹션 제목",
            preview_latin_title: "Section Title",
            preview_body_intro: "본문 글씨가 이 정도 크기로 보입니다. 줄 간격과 진하기도 함께 확인해 보세요.",
            preview_latin_body: "Body text sample for checking Latin typography.",
