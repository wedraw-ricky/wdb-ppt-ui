...
> Style rules for Python code under `.claude/skills/ppt-master/scripts/` and any Python that ships with the skill. Derived from the de facto patterns in the existing codebase.
...
| Module | Owns |
|---|---|
| [`image_backends/backend_common.py`](../../.claude/skills/ppt-master/scripts/image_backends/backend_common.py) | HTTP download, retry, image format detection, save-with-Pillow-transcode |
| [`image_sources/provider_common.py`](../../.claude/skills/ppt-master/scripts/image_sources/provider_common.py) | License classification, query simplification, scoring, attribution text, dataclasses |
| [`project_utils.py`](../../.claude/skills/ppt-master/scripts/project_utils.py) | Canvas formats, project path conventions |
| [`error_helper.py`](../../.claude/skills/ppt-master/scripts/error_helper.py) | User-facing error message templates |
| [`console_encoding.py`](../../.claude/skills/ppt-master/scripts/console_encoding.py) | `configure_utf8_stdio()` — force UTF-8 console for CLI entries (§4) |
...
|---|---|
| A small CLI utility | [`total_md_split.py`](../../.claude/skills/ppt-master/scripts/total_md_split.py), [`gemini_watermark_remover.py`](../../.claude/skills/ppt-master/scripts/gemini_watermark_remover.py) |
| A multi-backend / dispatcher CLI | [`image_search.py`](../../.claude/skills/ppt-master/scripts/image_search.py), [`image_gen.py`](../../.claude/skills/ppt-master/scripts/image_gen.py) |
| A library / shared helper | [`image_sources/provider_common.py`](../../.claude/skills/ppt-master/scripts/image_sources/provider_common.py), [`image_backends/backend_common.py`](../../.claude/skills/ppt-master/scripts/image_backends/backend_common.py) |
| A class-based checker / validator | [`svg_quality_checker.py`](../../.claude/skills/ppt-master/scripts/svg_quality_checker.py) |
